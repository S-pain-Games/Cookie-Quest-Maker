...
namespace CQM.Databases
{
    ...
    public class DataBuilders : MonoBehaviour
    {
        ...
        public void BuildData(ComponentsDatabase c)
        {
            ...
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID("mayor_problem"));
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID("out_of_lactose"));
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID("sacred_egg"));
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID("explosive_chocolate"));
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID("not_so_dirty_rats"));
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID("stingy_taxes"));
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID("crazy_cows"));
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID("the_cake_was_not_a_lie"));
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID("the_lord_of_the_ducks"));
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID("natural_chocolate_milkshake"));
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID("the_stolen_pendant"));
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID("a_regular_day"));
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID("mushroom_profecy"));
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID("mayor_worries"));
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID("old_friends"));
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID("high_voltage_treatment"));
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID("full_artifact_panic"));
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID("fungal_metamorphosis"));
            c.m_GameStoriesStateComponent.m_MainStoriesToStartOrder.Add(new ID(""));

            // Seconday Stories
            c.m_GameStoriesStateComponent.m_AvailableSecondaryStoriesToStart.Add(new ID("floral_collect"));
            c.m_GameStoriesStateComponent.m_AvailableSecondaryStoriesToStart.Add(new ID("without_bread"));
            c.m_GameStoriesStateComponent.m_AvailableSecondaryStoriesToStart.Add(new ID("cupcakes_everywhere"));
            c.m_GameStoriesStateComponent.m_AvailableSecondaryStoriesToStart.Add(new ID("forgotten_bell"));
            c.m_GameStoriesStateComponent.m_AvailableSecondaryStoriesToStart.Add(new ID("the_beast"));
            c.m_GameStoriesStateComponent.m_AvailableSecondaryStoriesToStart.Add(new ID("saving_the_wheat"));
            c.m_GameStoriesStateComponent.m_AllSecondaryStories.Add(new ID("floral_collect"));
            c.m_GameStoriesStateComponent.m_AllSecondaryStories.Add(new ID("without_bread"));
            c.m_GameStoriesStateComponent.m_AllSecondaryStories.Add(new ID("cupcakes_everywhere"));
            c.m_GameStoriesStateComponent.m_AllSecondaryStories.Add(new ID("forgotten_bell"));
            c.m_GameStoriesStateComponent.m_AllSecondaryStories.Add(new ID("the_beast"));
            c.m_GameStoriesStateComponent.m_AllSecondaryStories.Add(new ID("saving_the_wheat"));
